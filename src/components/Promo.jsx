  ...
  return (
    <div className="promo w-full fixed h-screen z-10 top-0 flex items-center">
      <div className="container promo_inner">
        ...
        <button
          className="bg-red text-white font-normal hover:shadow-xl duration-500 transition-all text-xl py-3 px-6 rounded-md mt-8 hover:bg-opacity-80"
